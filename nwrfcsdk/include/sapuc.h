/* @(#) $Id: //bas/720_REL/src/include/sapuc.h#17 $ SAP*/
/* CCQ_CCU_FILE_OFF */ /* CCQ_COV_FILE_OFF */ /* CCQ_IPV6_SUPPORT_FILE_OK */ /* CCQ_USE_TIME_T_FILE_OK */
#ifndef SAPUC_H
#define SAPUC_H "$Id: //bas/720_REL/src/include/sapuc.h#17 $"
 ...
 *     #define SAP_IDENT "@(#) $Id: //bas/720_REL/src/include/sapuc.h#17 $"
 ...
 *     SAP_IDENTN(name,"@(#) $Id: //bas/720_REL/src/include/sapuc.h#17 $")
...
#define ttynameU(filedes)              SAP_UNAME(ttyname)(filedes)
  ...
  #include <sys/types.h>
	...
	#ifndef SAPwithUNICODE
	#undef  ctimeU
	#define ctimeU(X) ctime64(X)
	#undef  ctime_rU
	#define ctime_rU(X,Y) ctime64_r(X,Y)
	#endif
  #endif
#endif /* SAPonOS400 */
